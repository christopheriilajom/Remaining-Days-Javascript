    ...
    if(isNaN(age)){
        ...
        if(age > assumedNumbers.AGE){
            ...
            if(age === assumedNumbers.AGE){
                ...
                document.getElementById('listTable').innerHTML = `<li>You have</li> <li><i class="fas fa-sun"></i> ${daysLeft} days</li> <li><i class="fas fa-calendar-week"></i> ${weekLeft} weeks</li> <li><i class="far fa-moon"></i> ${monthLeft} months </li>` 
